...
export default function TaskForm() {
    ...
    function closeForm() {
        ...
        if (isFormDirty) {
            const confirmClose = window.confirm("Bạn có chắc chắn muốn đóng? Dữ liệu chưa được lưu sẽ bị mất.");
    ...
    return (
        <div className='z-100 fixed top-0 left-0 w-[100vw] h-[100vh] flex justify-center items-center'>
            ...
            <div className='relative z-110 w-[70vw] h-[95vh] flex flex-col items-center bg-white border border-gray-border rounded-md shadow-md overflow-y-auto'>
                ...
                <div className='absolute right-4 p-1 rounded-md cursor-pointer duration-200 hover:bg-light-gray active:scale-90'onClick={closeForm}>
                        <svg className='w-[25px] h-[25px] aspect-square'
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                            <path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/>
                        </svg>
                ...
                <div className='w-full h-full flex flex-col items-center px-3 pb-3'>
                    ...
                    <div className='w-full mt-2 flex justify-end'>
                        ...
                        { taskState.slice(0, 4).includes('UPDATE') && <Button className='w-[100px] !font-semibold !ml-1' color='danger' variant="solid" onClick={() => deleteTask()}>Xóa</Button> }
                    </div>
                </div>
            </div>
        </div>
